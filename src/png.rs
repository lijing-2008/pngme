...
mod tests {
    ...
    #[test]
    fn test_from_files() {
        let png = Png::from_file("test1.png").unwrap();
        println!("{}", png);
    }
    ...
    fn test_invalid_chunk() {
        ...
        let mut bad_chunk_1 = vec![0, 0, 0, 1, 115, 82, 71, 66, 0, 174, 206, 28, 233];
        chunk_bytes.append(&mut bad_chunk_1);
    ...
    fn test_png_from_image_file() {
        ...
        let v = png.chunks;
        for val in v {
            println!("{}", val.chunk_type().to_string());
        }
    }
